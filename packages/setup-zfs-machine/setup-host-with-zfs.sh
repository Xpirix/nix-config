...
if [ "$FLAKE" == "YES" ]; then
  # Check if repo is cloned. If it is update it, otherwise clone it
  # This could happen if you are running this script a second time
  if [ -d /mnt/etc/nixos_org ]; then
